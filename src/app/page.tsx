      ...
      <AnimatePresence>
        {showFullVideo && (
          ...
          >
            ...
            >
              {/* Corner accents */}
              <div className="absolute -top-3 -left-3 w-16 h-16 border-t border-l border-white/15 pointer-events-none" />
              <div className="absolute -bottom-3 -right-3 w-16 h-16 border-b border-r border-white/15 pointer-events-none" />

              <div className="relative glass-strong border border-white/10 shadow-2xl w-full h-full overflow-hidden">
                <iframe
              ...
              <motion.button
                ...
                className="absolute -top-12 -right-12 md:-top-14 md:-right-14 w-10 h-10 glass border border-white/10 hover:border-white/25 flex items-center justify-center transition-colors z-50"
              ...
              >
                <div className="glass border border-white/8 px-4 py-1.5">
                  <span className="font-mono text-xs tracking-[0.2em] text-white/40 uppercase">Full Showcase — 4K</span>
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              <div className="glass border border-white/8 px-4 py-2 font-mono text-xs text-white/30">
      ...
      <section id="projects" className="min-h-screen flex flex-col items-center justify-center px-6 relative z-10 py-24">
        <div className="max-w-7xl w-full">
          ...
          >
            ...
            <p className="font-mono text-xs text-white/25 tracking-[0.3em] uppercase">Selected Works &amp; Open Source</p>
          </motion.div>
              ...
              return (
                ...
                >
                  <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                      {/* Corner marks */}
                      <div className="absolute -top-4 -left-4 w-16 h-16 border-t border-l border-white/10 pointer-events-none" />
                      <div className="absolute -bottom-4 -right-4 w-16 h-16 border-b border-r border-white/8 pointer-events-none" />

                      <div className="relative glass-strong border border-white/8 shadow-2xl overflow-hidden">
                      ...
                      >
                        ...
                        <motion.a
                          ...
                          whileHover={{ scale: 1.03 }}
                          whileTap={{ scale: 0.97 }}
                          className="flex-1 px-5 py-2.5 glass border border-white/10 hover:border-white/25 font-mono text-sm text-white/50 hover:text-white transition-colors flex items-center justify-center gap-2"
                        >
                    ...
                    >
                      <motion.div
                        ...
                        viewport={{ once: true }}
                      >
                        <span className="inline-block px-4 py-1 glass border border-white/8 font-mono text-xs tracking-[0.2em] text-white/35 uppercase">
                          {project.label}
                        </span>
                      </motion.div>
                      ...
                      <motion.div
                        ...
                        className="space-y-3"
                      >
                        <p className="font-mono text-sm text-white/45 leading-relaxed">{project.description}</p>
                        <p className="font-mono text-sm text-white/45 leading-relaxed">{project.secondDescription}</p>
                      </motion.div>
                      ...
                      >
                        {project.features.map((feature, fi) => (
                          ...
                          >
                            <div className="w-4 h-px bg-white/20 group-hover:bg-white/50 transition-colors" />
                            <span className="font-mono text-sm text-white/30 group-hover:text-white/70 transition-colors">{feature}</span>
                          </motion.div>
                        ))}
                      </motion.div>
                    </motion.div>
      ...
      <section id="quotes" className="min-h-screen flex items-center justify-center px-6 relative z-10 py-24">
        <div className="max-w-5xl w-full">
          ...
          >
            ...
            <p className="font-mono text-xs text-white/25 tracking-[0.3em] uppercase">Quotes on Innovation, Programming &amp; Design</p>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="glass-strong border border-white/7 p-12 md:p-16 relative overflow-hidden">
              {/* Corner marks */}
              <div className="absolute top-0 left-0 w-12 h-12 border-t border-l border-white/10" />
              <div className="absolute bottom-0 right-0 w-12 h-12 border-b border-r border-white/8" />
              ...
              <div className="relative min-h-[280px] flex flex-col justify-center">
                <AnimatePresence mode="wait" custom={direction}>
                  ...
                  >
                    <div className="mb-6">
                      <span className="inline-block px-4 py-1 glass border border-white/8 font-mono text-xs tracking-[0.2em] text-white/30 uppercase">
                        {currentQuote.category}
                      </span>
                    </div>

                    <blockquote className="font-display text-2xl md:text-3xl text-white/80 font-light leading-relaxed mb-8 relative">
                      <span className="text-white/8 text-6xl absolute -top-2 -left-2 md:-left-6 select-none">&ldquo;</span>
                      {currentQuote.text}
                      <span className="text-white/8 text-6xl absolute -bottom-6 -right-2 md:-right-6 select-none">&rdquo;</span>
                    </blockquote>
              ...
              <div className="flex items-center justify-between mt-10">
                <motion.button
                  ...
                  className="w-10 h-10 glass border border-white/8 hover:border-white/20 flex items-center justify-center transition-colors group"
                ...
                <div className="flex items-center gap-2">
                  {QUOTES.map((_, index) => (
                    <button
                      ...
                      className={`transition-all ${index === currentQuoteIndex ? 'w-6 h-1 bg-white' : 'w-1 h-1 bg-white/20 hover:bg-white/40'}`}
                    />
                  ))}
                </div>
      ...
      <section id="contact" className="min-h-screen flex flex-col items-center justify-center px-6 relative z-10 py-24">
        <div className="max-w-4xl w-full text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="inline-block px-5 py-1.5 glass border border-white/8 font-mono text-xs tracking-[0.25em] text-white/30 uppercase mb-8">
              Get in touch
            </span>
            <h2 className="font-display text-5xl md:text-7xl text-gradient mb-8 font-light tracking-tight">Let&apos;s Connect</h2>
            <p className="font-mono text-white/30 text-sm mb-12">Interested in working together? Feel free to reach out.</p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <motion.a
                ...
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
                className="px-10 py-3.5 glass border border-white/10 hover:border-white/25 font-mono text-sm text-white/50 hover:text-white transition-colors"
              >
                Discord
              </motion.a>
              <motion.a
        ...
        >
          <div className="w-48 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent mx-auto mb-4" />

...
import Head from 'next/head'; // ← added for Discord embed
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>doom.lat — Enter the Lair ⚡</title>
        <meta name="description" content="Cyber wizardry & code chaos—projects, hacks, and creations await 💀" />

        {/* Discord / Open Graph */}
        <meta property="og:title" content="doom.lat — Enter the Lair ⚡" />
        <meta property="og:description" content="Cyber wizardry & code chaos—projects, hacks, and creations await 💀" />
        <meta property="og:image" content="https://doom.lat/assets/doom-preview.png" />
        <meta property="og:url" content="https://doom.lat" />
                ...
                <details className="group">
                  ...
                  <div className="px-6 md:px-12 lg:px-20 pb-10">
                    <div className="ml-0 sm:ml-16 flex flex-col lg:flex-row gap-8 lg:gap-16">
                        ...
                        <div className="flex gap-3">
                          ...
                          >
                            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
                              <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.744.083-.729.083-.729 1.205.084 1.839 1.239 1.839 1.239 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.303-5.467-1.332-5.467-5.931 0-1.31.468-2.381 1.235-3.222-.123-.303-.535-1.523.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.29-1.552 3.296-1.23 3.296-1.23.654 1.653.242 2.873.119 3.176.77.841 1.233 1.912 1.233 3.222 0 4.61-2.807 5.625-5.479 5.921.43.371.813 1.102.813 2.222v3.293c0 .319.192.694.801.576C20.565 21.796 24 17.299 24 12c0-6.627-5.373-12-12-12z"/>
                            </svg>
                            View GitHub
                          </a>
                        </div>
                      ...
                      <ul className="flex-1 list-disc ml-4 text-white/30 space-y-1">
